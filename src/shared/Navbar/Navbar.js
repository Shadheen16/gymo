          ...
          <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
            <div className="relative flex items-center justify-between h-16">
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                {
                  user.email ? <div className="lg:flex"> <p className="mr-2 text-white font-bold hidden lg:block">
                    ...
                    <Link to='/login'><button className="flex bg-green-400 px-2 py-1 hover:bg-yellow-300 text-gray-900"><span> Login</span><span><svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
